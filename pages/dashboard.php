    ...
    <div class="container-fluid py-4">
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1">San Blas</h5>
                    <p>Playas de arena blanca, cultura Guna auténtica, biodiversidad impresionante.</p>
                  </div>
                </div>
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1">Isla Taboga</h5>
                    <p>Es una isla que se encuentra en el golfo de Panamá, a unos 20 km de la ciudad de Panamá.</p>
                  </div>
                </div>
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1"> Half Moon Cay</h5>
                    <p>Es una de las cerca de 700 islas que componen el archipiélago de las Bahamas.</p>
                  </div>
                </div>
              </div>
