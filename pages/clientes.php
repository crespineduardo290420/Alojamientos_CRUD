...
$sql = "SELECT nombre, correo, lugar, fecha, estado FROM clientes"; // Ajustar los nombres de las columnas según tu base de datos
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">San Blas</p>
                        <p class="text-xs text-secondary mb-0">Panamá</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">En proceso</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">03/03/25</span>
                      </td>
